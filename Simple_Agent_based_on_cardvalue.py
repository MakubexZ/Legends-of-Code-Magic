...
# Simple agent for dealing with the Wood League which is very intuitive
# This agent would choose creatures of highest value and summon minion to attack opponent as quick as possible to defeat opponent.
...
while True:
    ...
    print_str = ""
    # In draft stage agent choose creatures with highest card value
    if player_mana == 0:
    ...
    # In battle stage agent use card in descending order of card value
    # Then attack opponent only in order to finish the game ASAP
    else:
